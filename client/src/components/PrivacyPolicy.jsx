...
<p>This privacy notice for <span>Gift4U</span> (doing business as <span >Gift4U</span>) (“<strong>Company</strong>,” “<strong>we</strong>,” “<strong>us</strong>,” or “<strong>our</strong>“), describes how and why we might collect, store, use, and/or share (“<strong>process</strong>“) your information when you use our services (“<strong>Services</strong>“), such as when you:</p>
<ul>
<li>Visit our website at <span >gift4u.com</span>, or any website of ours that links to this privacy notice</li>
<li><span >[Download and use our application(s), such as our mobile application — Gift4u, our Facebook application — [Facebook App Name], or any other application of ours that links to this privacy notice]</span></li>
<li>Engage with us in other related ways ― including any sales, marketing, or events</li>
</ul>
<p><strong>Questions or concerns?</strong> Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <span >info@gift4u.com</span>.</p>
<p>This privacy policy was created by Gift4u Privacy Policy Generator</p>
<h3>SUMMARY OF KEY POINTS</h3>
<p><strong><em>This summary provides key points from our privacy notice, but you can find out more details about any of these topics by using our table of contents below to find the section you are looking for.</em></strong></p>
<p><strong>What personal information do we process?</strong> When you visit, use, or navigate our Services, we may process personal information depending on how you interact with <span >Gift4u</span> and the Services, the choices you make, and the products and features you use.</p>
<p><strong>Do we process any sensitive personal information?</strong> <span >[We do not process sensitive personal information. / We may process sensitive personal information when necessary with your consent or as otherwise permitted by applicable law.]</span></p>
<p><strong>Do you receive any information from third parties?</strong> We may receive information from public databases, marketing partners, social media platforms, and other outside sources.</p>
...
<p><strong>How do I exercise my rights?</strong> The easiest way to exercise your rights is by filling out our data subject request form available here: <span >[DSAR Form URL]</span>, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.</p>
<p>Want to learn more about what <span >Gift4u</span> does with any information we collect? Review the notice in full below.</p>
...
8. IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?<br/>
9. HOW LONG DO WE KEEP YOUR INFORMATION?<br/>
10. HOW DO WE KEEP YOUR INFORMATION SAFE?<br/>
11. DO WE COLLECT INFORMATION FROM MINORS?<br/>
12. WHAT ARE YOUR PRIVACY RIGHTS?<br/>
13. CONTROLS FOR DO-NOT-TRACK FEATURES<br/>
14. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?<br/>
15. DO VIRGINIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?<br/>
16. DO WE MAKE UPDATES TO THIS NOTICE?<br/>
17. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?<br/>
18. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</p>
<h3>1. WHAT INFORMATION DO WE COLLECT?</h3>
<p><strong>Personal information you disclose to us</strong></p>
<p><em><strong>In Short:</strong> We collect personal information that you provide to us.</em></p>
<p>We collect personal information that you voluntarily provide to us when you <span >[register on the Services,]</span> express an interest in obtaining information about us or our products and Services, when you participate in activities on the Services, or otherwise when you contact us.</p>
<p><strong>Personal Information Provided by You.</strong> The personal information that we collect depends on the context of your interactions with us and the Services, the choices you make, and the products and features you use. The personal information we collect may include the following:</p>
<ul>
<li><span >[Personal Info Collected]</span></li>
<li><span >[Personal Info Collected]</span></li>
<li><span >[Personal Info Collected]</span></li>
</ul>
<p><strong>Sensitive Information.</strong> <span >[We do not process sensitive information. / When necessary, with your consent or as otherwise permitted by applicable law, we process the following categories of sensitive information:</span></p>
<ul>
<li><span >[Sensitive Info Collected]</span></li>
<li><span >[Sensitive Info Collected]</span></li>
<li><span >[Sensitive Info Collected]]</span></li>
</ul>
<p><strong>Payment Data.</strong> We may collect data necessary to process your payment if you make purchases, such as your payment instrument number (such as a credit card number), and the security code associated with your payment instrument. All payment data is stored by <span >PayPal</span>. You may find their privacy notice link(s) here: <span >[Vendor Privacy Policy]</span>.</p>
<p><strong>Social Media Login Data.</strong> We may provide you with the option to register with us using your existing social media account details, like your Facebook, Twitter, or other social media account. If you choose to register in this way, we will collect the information described in the section called “<em>HOW DO WE HANDLE YOUR SOCIAL LOGINS?</em>” below.</p>
<p><span >[<strong>Application Data.</strong> If you use our application(s), we also may collect the following information if you choose to provide us with access or permission:</span></p>
<ul>
<li><em><span >Geolocation Information.</span></em> <span >We may request access or permission to track location-based information from your mobile device, either continuously or while you are using our mobile application(s), to provide certain location-based services. If you wish to change our access or permissions, you may do so in your device’s settings.</span></li>
<li><em><span >Mobile Device Access.</span></em> <span >We may request access or permission to certain features from your mobile device, including your mobile device’s bluetooth, calendar, camera, own, and other features. If you wish to change our access or permissions, you may do so in your device’s settings.</span></li>
<li><em><span >Mobile Device Data.</span></em> <span >We automatically collect device information (such as your mobile device ID, model, and manufacturer), operating system, version information and system configuration information, device and application identification numbers, browser type and version, hardware model Internet service provider and/or mobile carrier, and Internet Protocol (IP) address (or proxy server). If you are using our application(s), we may also collect information about the phone network associated with your mobile device, your mobile device’s operating system or platform, the type of mobile device you use, your mobile device’s unique device ID, and information about the features of our application(s) you accessed.</span></li>
<li><em><span >Push Notifications.</span></em> <span >We may request to send you push notifications regarding your account or certain features of the application(s). If you wish to opt out from receiving these types of communications, you may turn them off in your device’s settings.</span></li>
</ul>
...
<p>Like many businesses, we also collect information through cookies and similar technologies. You can find out more about this in our Cookie Notice: [Cookie Notice URL].</p>
...
<p><span >[<strong>Information collected when you use our Facebook application(s).</strong> We by default access your <a href="https://www.facebook.com/about/privacy/" target="_blank" rel="noopener">Facebook</a> basic account information, including your name, email, gender, birthday, current city, and profile picture URL, as well as other information that you choose to make public. We may also request access to other permissions related to your account, such as friends, check-ins, and likes, and you may choose to grant or deny us access to each individual permission. For more information regarding Facebook permissions, refer to the <a href="https://developers.facebook.com/docs/permissions/reference" target="_blank" rel="noopener">Facebook Permissions Reference</a> page.]</span></p>
...
<li><strong>To send you marketing and promotional communications.</strong> We may process the personal information you send to us for our marketing purposes, if this is in accordance with your marketing preferences. You can opt out of our marketing emails at any time. For more information, see “<em>WHAT ARE YOUR PRIVACY RIGHTS?</em>” below).</li>
<li><strong>To deliver targeted advertising to you.</strong> We may process your information to develop and display personalized content and advertising tailored to your interests, location, and more. For more information see our Cookie Notice: <span >[Cookie Notice URL]</span>.</li>
...
<li><strong>When we use Google Maps Platform APIs.</strong> We may share your information with certain Google Maps Platform APIs (e.g., Google Maps API, Places API). To find out more about Google’s Privacy Policy, please refer to this <a href="https://policies.google.com/privacy" target="_blank" rel="noopener">link</a>. We use certain Google Maps Platform APIs to retrieve certain information when you make location-specific requests. This includes: <span >[List of Information Collected]</span>, and other similar information. A full list of what we use information for can be found in this section and in the previous section titled “<em>HOW DO WE PROCESS YOUR INFORMATION?</em>”. [We obtain and store on your device (‘cache’) your location for <span >[#]</span> months. You may revoke your consent anytime by contacting us at the contact details provided at the end of this document. The Google Maps Platform APIs that we use store and access cookies and other information on your devices. If you are a user currently in the European Economic Area (EU countries, Iceland, Liechtenstein and Norway) or the United Kingdom, please take a look at our Cookie Notice, which can be found at this link: <span >[Cookie Notice URL]</span>.</li>
...
<li><strong>Other Users.</strong> When you share personal information <span >[(for example, by posting comments, contributions, or other content to the Services)]</span> or otherwise interact with public areas of the Services, such personal information may be viewed by all users and may be publicly made available outside the Services in perpetuity. If you interact with other users of our Services and register for our Services through a social network (such as Facebook), your contacts on the social network will see your name, profile photo, and descriptions of your activity. Similarly, other users will be able to view descriptions of your activity, communicate with you within our Services, and view your profile.</li>
...
<p>We may use cookies and similar tracking technologies (like web beacons and pixels) to access or store information. Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice: <span >[Cookie Notice URL]</span>.</p>
...
<p>Our servers are located in <span >[Countries where Server is Located]</span>. If you are accessing our Services from outside <span >[Countries where Server is Located]</span>, please be aware that your information may be transferred to, stored, and processed by us in our facilities and by those third parties with whom we may share your personal information (see “<em>WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</em>” above), in <span >the US</span>, and other countries.</p>
...
<p>We have implemented measures to protect your personal information, including by using the European Commission’s Standard Contractual Clauses for transfers of personal information between our group companies and between us and our third-party providers. These clauses require all recipients to protect all personal information that they process originating from the EEA or UK in accordance with European data protection laws and regulations. Our Data Processing Agreements that include Standard Contractual Clauses are available here: <span >[Standard Contractual Clauses URL]</span>. We have implemented similar appropriate safeguards with our third-party service providers and partners and further details can be provided upon request.</p>
<p>Binding Corporate Rules:</p>
<p>These include a set of Binding Corporate Rules (“BCRs”) established and implemented by <span >Gift4u</span>. Our BCRs have been recognized by EEA and UK data protection authorities as providing an adequate level of protection to the personal information we process internationally. You can find a copy of our BCRs here: <span >[BCRs URL]</span>.</p>
<p><span >[EU-US]</span> and <span >[Swiss-US]</span> Privacy Shield Framework<span >[s]</span></p>
<p><span >Gift4u</span> and the following entities and subsidiaries: <span >[List of Entities/Subsidiaries]</span> comply with the <span >[EU-US]</span> and <span >[Swiss-US]</span> Privacy Shield Framework<span >[s]</span> as set forth by the US Department of Commerce regarding the collection, use, and retention of personal information transferred from <span >[the European Union (EU)]</span>, <span >[the UK]</span>, and <span >[Switzerland]</span> to the United States. Although Privacy Shield is no longer considered a valid transfer mechanism for the purposes of <span >[EU]</span> and <span >[Swiss]</span> data protection law, in light of the judgment of the Court of Justice of the European Union in Case C-311/18 and opinion of the Federal Data Protection and Information Commissioner of Switzerland dated 8 September 2020, <span >Gift4u</span> will continue to comply with the principles of the <span >[EU-US]</span> and <span >[Swiss-US]</span> Privacy Shield Framework<span >[s]</span>. To learn more about the Privacy Shield program, please visit <a href="https://www.privacyshield.gov/welcome" target="_blank" rel="noopener">www.privacyshield.gov</a>. To view our certification, please visit <span >[Privacy Shield Certification URL]</span>.</p>
<p><span >Gift4u</span> adheres to and complies with the Privacy Shield Principles when processing personal information from <span >[the EU]</span>, <span >[UK]</span>, or <span >[Switzerland]</span>. If we have received your personal information in the United States and subsequently transfer that information to a third party acting as our agent, and such third party agent processes your personal information in a manner inconsistent with the Privacy Shield Principles, we will remain liable unless we can prove we are not responsible for the event giving rise to the damage.</p>
<p>With respect to personal information received or transferred pursuant to the Privacy Shield Framework<span >[s]</span>, <span >Gift4u</span> is subject to the investigatory and enforcement powers of the US Federal Trade Commission (“FTC”). In certain situations, we may be required to disclose personal information in response to lawful requests by public authorities, including to meet national security or law enforcement requirements.</p>
<p>If you have any questions or concerns relating to <span >Gift4u</span>’s Privacy Shield certification, please write to us at the contact details below. We commit to resolving any complaints or disputes about our collection and use of your personal information under the Privacy Shield. <span >[However, if you have an unresolved complaint in connection with our certification, we commit to cooperating with the panel established by [the EU data protection authorities (DPAs)], [the UK Information Commissioner], and [the Swiss Federal Data Protection and Information Commissioner], as applicable, and to comply with the advice given by them in respect of the complaint. Click here for a <a href="https://ec.europa.eu/justice/article-29/structure/data-protection-authorities/index_en.htm" target="_blank" rel="noopener">list of EU DPAs</a>. / However, if you have an unresolved complaint in connection with our certification, you may contact our independent dispute resolution provider based in the [EU/United States], [Dispute Resolution Provider Name]. Please visit [Dispute Resolution Provider URL] for more information or to file a complaint. These services are provided to you free of charge.]</span></p>
<p>In limited situations, <span >[EU]</span>, <span >[UK]</span>, and <span >[Swiss]</span> individuals may seek redress from the Privacy Shield Panel, a binding arbitration mechanism.</p>
<p>Please be sure to review the following sections of this Privacy Notice for additional details relevant to <span >Gift4u</span>’s participation in the <span >[EU-US]</span> and <span >[Swiss-US]</span> Privacy Shield:</p>
<ul>
<li><em>WHAT INFORMATION DO WE COLLECT?</em> To learn more about the types of personal data <em><span >Gift4u</span></em> collects.</li>
<li><em>HOW DO WE PROCESS YOUR INFORMATION?</em> To learn more about the purposes for which <em><span >Gift4u</span></em> collects and uses personal information about you.</li>
<li><em>WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</em> To learn more about the type or identity of third parties to which <em><span >Gift4u</span></em> discloses personal information, and the purposes for which we do so.</li>
...
<p>If you are located in the EEA or UK and you believe we are unlawfully processing your personal information, you also have the right to complain to your local data protection supervisory authority. You can find their contact details here: <a href="https://edpb.europa.eu/about-edpb/about-edpb/members_en" target="_blank" rel="noopener">https://edpb.europa.eu/about-edpb/about-edpb/members_en</a>.</p>
...
<p>If you have questions or comments about your privacy rights, you may email us at <span >[Email Address]</span>.</p>
...
<ul>
<li>Category A – <span >[Retention Period]</span></li>
<li>Category B – <span >[Retention Period]</span></li>
<li>Category C – <span >[Retention Period]</span></li>
<li>Category D – <span >[Retention Period]</span></li>
<li>Category E – <span >[Retention Period]</span></li>
<li>Category F – <span >[Retention Period]</span></li>
<li>Category G – <span >[Retention Period]</span></li>
<li>Category H – <span >[Retention Period]</span></li>
<li>Category I – <span >[Retention Period]</span></li>
<li>Category J – <span >[Retention Period]</span></li>
<li>Category K – <span >[Retention Period]</span></li>
<li>Category L – <span >[Retention Period]</span></li>
</ul>
...
<p><span >Gift4u</span> collects and shares your personal information through:</p>
<ul>
<li>Targeting cookies/Marketing cookies</li>
<li>Social media cookies</li>
<li>Beacons/Pixels/Tags</li>
<li>Click redirects: <span >[Click Redirects]</span></li>
<li>Social media plugins: <span >[Social Media Plugins]</span>. We use social media features, such as a “Like” button, and widgets, such as a “Share” button in our Services. Such features may process your Internet Protocol (IP) address and track which page you are visiting on our website. We may place a cookie to enable the feature to work correctly. If you are logged in on a certain social media platform and you interact with a widget or button belonging to that social media platform, this information may be recorded to your profile of such social media platform. To avoid this, you should log out from that social media platform before accessing or using the Services. Social media features and widgets may be hosted by a third party or hosted directly on our Services. Your interactions with these features are governed by the privacy notices of the companies that provide them. By clicking on one of these buttons, you agree to the use of this plugin and consequently the transfer of personal information to the corresponding social media service. We have no control over the essence and extent of these transmitted data or their additional processing.</li>
<li><span >[Other]</span></li>
</ul>
<p>More information about our data collection and sharing practices can be found in this privacy notice and our Cookie Notice: <span >[Cookie Notice URL]</span>.</p>
<p><span >[You can opt out from the selling or sharing of your personal information by disabling cookies in Cookie Preference Settings and clicking on the Do Not Sell or Share My Personal Information link on our homepage.]</span></p>
<p>You may contact us by email at <span >[Email Address]</span>, by calling toll-free at <span >[Phone Number]</span>, by visiting <span >[Contact Form URL]</span>, or by referring to the contact details at the bottom of this document.</p>
...
<p><span >Gift4u</span> has disclosed the following categories of personal information to third parties for a business or commercial purpose in the preceding twelve (12) months:</p>
<ul>
...
<p><span >[Gift4u has not sold or shared any personal information to third parties for a business or commercial purpose in the preceding twelve (12) months. / Gift4u has sold or shared the following categories of personal information to third parties in the preceding twelve (12) months:</span></p>
<ul>
<li><span >Category A. Identifiers, such as contact details, like your real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, Internet Protocol address, email address, and account name.</span></li>
<li><span >Category B. Personal information, as defined in the California Customer Records law, such as your name, contact information, education, employment, employment history, and financial information.</span></li>
<li><span >Category C. Characteristics of protected classifications under California or federal law, such as gender or date of birth.</span></li>
<li><span >Category D. Commercial information, such as transaction information, purchase history, financial details, and payment information.</span></li>
<li><span >Category E. Biometric information, such as fingerprints and voiceprints.</span></li>
<li><span >Category F. Internet or other electronic network activity information, such as browsing history, search history, online behavior, interest data, and interactions with our and other websites, applications, systems, and advertisements.</span></li>
<li><span >Category G. Geolocation data, such as device location.</span></li>
<li><span >Category H. Audio, electronic, visual, and similar information, such as images and audio, video or call recordings created in connection with our business activities.</span></li>
<li><span >Category I. Professional or employment-related information, such as business contact details in order to provide you our services at a business level or job title, work history, and professional qualifications if you apply for a job with us.</span></li>
<li><span >Category J. Education information, such as student records and directory information.</span></li>
<li><span >Category K. Inferences drawn from any of the personal information listed above to create a profile or summary about, for example, an individual’s preferences and characteristics.</span></li>
<li><span >Category L. Sensitive personal information, such as account login information, drivers’ licenses, health data, precise geolocation, racial or ethnic origin, religious or philosophical beliefs, and sex life or sexual orientation.</span></li>
</ul>
<p><span >The categories of third parties to whom we sold personal information are:</span></p>
<ul>
...
<p><span >The categories of third parties to whom we shared personal information with are:</span></p>
<ul>
<li><span >Ad Networks</span></li>
<li><span >Affiliate Marketing Programs</span></li>
<li><span >Data Analytics Services</span></li>
...
<p>[<span >We do not process consumer’s sensitive personal information. / If the business collects any of the following:</span></p>
<ul>
<li><span >social security information, drivers’ licenses, state ID cards, passport numbers</span></li>
<li><span >account login information</span></li>
<li><span >credit card numbers, financial account information, or credentials allowing access to such accounts</span></li>
<li><span >precise geolocation</span></li>
<li><span >racial or ethnic origin, religious or philosophical beliefs, union membership</span></li>
<li><span >the contents of email and text, unless the business is the intended recipient of the communication</span></li>
<li><span >genetic data, biometric data, and health data</span></li>
<li><span >data concerning sexual orientation and sex life</span></li>
</ul>
<p><span >you have the right to direct that business to limit its use of your sensitive personal information to that use which is necessary to perform the Services.</span></p>
<p><span >Once a business receives your request, they are no longer allowed to use or disclose your sensitive personal information for any other purpose unless you provide consent for the use or disclosure of sensitive personal information for additional purposes.</span></p>
<p><span >Please note that sensitive personal Information that is collected or processed without the purpose of inferring characteristics about a consumer is not covered by this right, as well as the publicly available information.</span></p>
<p><span >To exercise your right to limit use and disclosure of sensitive personal Information, please email [Email Address] or visit: [DSAR Form URL].</span>]</p>
...
<li><span >[You may request to opt out from future selling or sharing of your personal information to third parties. Upon receiving an opt-out request, we will act upon the request as soon as feasibly possible, but no later than fifteen (15) days from the date of the request submission.]</span></li>
</ul>
</li>
</ul>
</li>
</ul>
<p>To exercise these rights, you can contact us by email at <span >[Email Address]</span>, by calling toll-free at <span >[Phone Number]</span>, by visiting <span >[Contact Form URL]</span>, or by referring to the contact details at the bottom of this document. If you have a complaint about how we handle your data, we would like to hear from you.</p>
<p><strong>Financial Incentives</strong></p>
<p>“Financial incentive” means a program, benefit, or other offering, including payments to consumers as compensation, for the disclosure, deletion, sharing, or sale of personal information.</p>
<p>The law permits financial incentives or a price or service difference if it is reasonably related to the value of the consumer’s data. A business must be able to explain how the financial incentive or price or service difference is reasonably related to the value of the consumer’s data. The explanation must include:</p>
<ul>
<li >
<ul>
<li >
...
<p>We may decide to offer a financial incentive (e.g., price or service difference) in exchange for the retention, sale or sharing of a consumer’s personal information.</p>
...
<p>If you choose to participate in the financial incentive you can withdraw from the financial incentive at any time by emailing us at <span >[Email Address]</span>, by calling us toll-free at <span >[Phone Number]</span>, by visiting <span >[Contact Form URL]</span>, or by referring to the contact details at the bottom of this document.</p>
<p><strong>Metrics</strong></p>
<p>Our metrics for all CCPA requests received for the previous calendar year can be found here: <span >[Metrics URL]</span>.</p>
...
<p>The information we collect, use, and disclose about you will vary depending on how you interact with <span >Gift4u</span> and our Services. To find out more, please visit the following sections above:</p>
<ul>
...
<li>Right to opt out of the processing of your personal data if it is used for targeted advertising, the sale of personal data, or profiling in furtherance of decisions that produce legal or similarly significant effects ([“profiling”/’profiling’])</li>
</ul>
<p><span >[Gift4u has not sold any personal data to third parties for business or commercial purposes. Gift4u will not sell personal data in the future belonging to website visitors, users, and other consumers. / Gift4u sells personal data to third parties or processes personal data for targeted advertising. Please see the following section to find out how you can opt out from further selling or sharing of your personal data for targeted advertising or profiling purposes.]</span></p>
<p><span >Exercise your rights provided under the Virginia CDPA</span></p>
<p>More information about our data collection and sharing practices can be found in this privacy notice and our Cookie Notice: <span >[Cookie Notice URL]</span>.</p>
<p><span >[You can opt out from the selling of your personal data, targeted advertising, or profiling by disabling cookies in Cookie Preference Settings.]</span></p>
<p>You may contact us by email at <span >[Email Address]</span>, by visiting <span >[Contact Form URL]</span>, or by referring to the contact details at the bottom of this document.</p>
...
<p><span >Right to appeal</span></p>
<p>If we decline to take action regarding your request, we will inform you of our decision and reasoning behind it. If you wish to appeal our decision, please email us at <span >[Email Address]</span>. Within sixty (60) days of receipt of an appeal, we will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions. If your appeal is denied, you may contact the Attorney General to <a href="https://www.oag.state.va.us/consumer-protection/index.php/file-a-complaint" target="_blank" rel="noopener">submit a complaint</a>.</p>
...
<p>If you have questions or comments about this notice, you may contact our Data Protection Officer (DPO), <span >[DPO Name]</span>, by email at <span >[Email Address]</span>, by phone at <span >[Phone Number]</span>, or by post to:</p>
<p><span >Gift4u</span><br/>
<span >[DPO Name]</span><br/>
<span >[Street Address]</span><br/>
<span >[City, State ZIP Code]</span><br/>
<span >[Country]</span></p>
<p>If you are a resident in the European Economic Area, the “data controller” of your personal information is <span >Gift4u</span>. <span >Gift4u</span> has appointed <span >[EEA Representative Name]</span> to be its representative in the EEA. You can contact them directly regarding the processing of your information by <span >Gift4u</span>, by email at <span >[Email Address]</span>, by visiting <span >[EEA Representative URL]</span>, by phone at <span >[Phone Number]</span>, or by post to:</p>
<p><span >[Street Address]</span><br/>
<span >[City, State ZIP Code]</span><br/>
<span >[Country]</span></p>
<p>If you are a resident in the United Kingdom, the “data controller” of your personal information is <span >Gift4u</span>. <span >Gift4u</span> has appointed <span >[UK Representative Name]</span> to be its representative in the UK. You can contact them directly regarding the processing of your information by <span >Gift4u</span>, by email at <span >[Email Address]</span>, by visiting <span >[UK Representative URL]</span>, by phone at <span >[Phone Number]</span>, or by post to:</p>
<p><span >[Street Address]</span><br/>
<span >[City, State ZIP Code]</span><br/>
<span >[Country]</span></p>
...
Phone: <span >[Phone Number]</span><br/>
Fax: <span >[Fax Number]</span></p>
<h3>18. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h3>
<p>Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it in some circumstances. To request to review, update, or delete your personal information, please visit: <span >[DSAR Form URL]</span>.</p>
